...
exports.onCreateWebpackConfig = ({ loaders, actions }) => {
  const logger = new Logger('space-jam-theme:onCreateWebpackConfig');
  ...
  try {
    theme_location = require.resolve('space-jam-theme');
  } catch (e) {
...
exports.onPreBootstrap = ({ store }) => {
  const logger = new Logger('space-jam-theme:onPreBoostrap');
...
exports.onCreateBabelConfig = ({ actions }) => {
  const logger = new Logger('space-jam-theme:onCreateBabelConfig');
